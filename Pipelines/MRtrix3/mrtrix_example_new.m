...
matlabbatch{3}.boutiques.fsl.eddy_correct.inputs_{1}.anyfilebranch.help = '4D dwi: the input diffusion-weighted image';
matlabbatch{3}.boutiques.fsl.eddy_correct.inputs_{1}.anyfilebranch.anyfile(1) = cfg_dep('dwidenoise: dwidenoise: output 1 - dwi_denoised.nii', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','outputs', '{}',{1}));
matlabbatch{3}.boutiques.fsl.eddy_correct.inputs_{2}.evaluatedbranch.help = 'reference number: volume that will be used as a reference for the registration';
matlabbatch{3}.boutiques.fsl.eddy_correct.inputs_{2}.evaluatedbranch.evaluated = 1;
...
matlabbatch{4}.boutiques.mrtrix3.dwi2mask.inputs_{1}.anyfilebranch.help = '4D dwi: the input diffusion-weighted image';
matlabbatch{4}.boutiques.mrtrix3.dwi2mask.inputs_{1}.anyfilebranch.anyfile(1) = cfg_dep('eddy_correct: eddy_correct: output 1 - dwi_eddy.nii', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','outputs', '{}',{1}));
matlabbatch{4}.boutiques.mrtrix3.dwi2mask.inputs_{2}.anyfilebranch.help = 'bvecs file (in FSL format)';
matlabbatch{4}.boutiques.mrtrix3.dwi2mask.inputs_{2}.anyfilebranch.anyfile(1) = cfg_dep('Parse BIDS Directory: dwi: bvec', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','dwi_bvec'));
...
matlabbatch{5}.boutiques.mrtrix3.dwi2tensor.inputs_{1}.anyfilebranch.help = '4D dwi: the input diffusion-weighted image';
matlabbatch{5}.boutiques.mrtrix3.dwi2tensor.inputs_{1}.anyfilebranch.anyfile(1) = cfg_dep('eddy_correct: eddy_correct: output 1 - dwi_eddy.nii', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','outputs', '{}',{1}));
matlabbatch{5}.boutiques.mrtrix3.dwi2tensor.inputs_{2}.anyfilebranch.help = 'bvecs file (in FSL format)';
matlabbatch{5}.boutiques.mrtrix3.dwi2tensor.inputs_{2}.anyfilebranch.anyfile(1) = cfg_dep('Parse BIDS Directory: dwi: bvec', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','dwi_bvec'));
matlabbatch{5}.boutiques.mrtrix3.dwi2tensor.inputs_{3}.anyfilebranch.help = 'bvals file (in FSL format)';
matlabbatch{5}.boutiques.mrtrix3.dwi2tensor.inputs_{3}.anyfilebranch.anyfile(1) = cfg_dep('Parse BIDS Directory: dwi: bval', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','dwi_bval'));
...
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.inputs_{2}.anyfilebranch.help = '3D Mask';
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.inputs_{2}.anyfilebranch.anyfile(1) = cfg_dep('dwi2mask: dwi2mask: output 1 - mask_brain.nii.gz', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','outputs', '{}',{1}));
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.outputs_{1}.outputs.help = 'ADC image';
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.outputs_{1}.outputs.directory(1) = cfg_dep('Make Directory: Make Directory ''tensorfit''', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','dir'));
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.outputs_{1}.outputs.string = 'adc.nii';
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.outputs_{2}.outputs.help = 'FA image';
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.outputs_{2}.outputs.directory(1) = cfg_dep('Make Directory: Make Directory ''tensorfit''', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','dir'));
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.outputs_{2}.outputs.string = 'fa.nii';
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.outputs_{3}.outputs.help = 'AD image: axial diffusivity';
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.outputs_{3}.outputs.directory(1) = cfg_dep('Make Directory: Make Directory ''tensorfit''', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','dir'));
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.outputs_{3}.outputs.string = 'ad.nii';
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.outputs_{4}.outputs.help = 'RD image: radial diffusivity';
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.outputs_{4}.outputs.directory(1) = cfg_dep('Make Directory: Make Directory ''tensorfit''', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','dir'));
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.outputs_{4}.outputs.string = 'rd.nii';
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.cmd = 'tensor2metric -force -mask i2 i1 -adc o1 -fa o2 -ad o3 -rd o4';
matlabbatch{7}.boutiques.mrtrix3.tensor2metric.usedocker_.dockerimg = 'bids/mrtrix3_connectome';
